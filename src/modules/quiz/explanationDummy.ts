...
export const explanationDummy: Explanation[] = [{'explanation': 'Server Components는 서버에서 렌더링되며, Client Components는 클라이언트에서 렌더링됩니다. 이 차이는 각 컴포넌트의 사용 케이스와 성능에 영향을 미칩니다.'},
