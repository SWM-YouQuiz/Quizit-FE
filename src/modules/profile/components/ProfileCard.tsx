...
const ProfileCard = () => {
    ...
    return (
        <Link className="flex space-x-3 px-5" href="profile/badge">
            <div className="grid place-items-center border border-neutral-100 w-18 h-18 rounded-full">
                <Image src={image} width={72} height={72} alt={"profileImage"} />
            </div>
            <div className="flex-grow flex justify-between">
                <div className="flex flex-col justify-between">
                    ...
                    <div className="bg-primary-100 px-2 py-1 text-primary-900 rounded text-[13px]">하루 목표 {user.dailyTarget}개</div>
                </div>
